...
var config = {
	...
	charts:[
	{	title:"Our Castle and Our Keep", type:"pie", statistic: 'sumCat',
		distance: 1, units: 'miles',
	...
	{	title:"And another 100 people...", type:"pyramid", statistic: 'sum',
		distance: 1, units: 'miles',
	...
	{	title:"... just got off of the train", type:"pie", statistic: 'sum',
		distance: 1, units: 'miles',
		description:"Method of commute (2006-2010 ACS 5-yr estimate)",
		dataURL: 'censusACSURL',
		data: [	{field:'B08301_003E', label:'Drove Alone', category:'Private Vehicle'},
	...
	{	title:"O hallowed halls and vine draped walls...", type:"stackedBar", statistic: 'sum',
		distance: 1, units: 'miles',
		colors: ['#01DF01', '#58FA58', '#BCF5A9'],
		description:"School Enrollment by Race (2006 - 2010 Census ACS)",
		dataURL: 'censusACSURL',
		data: [ {field:'C14007A_003E', label:'Enrolled in nursery school, preschool, kindergarten', category:'White'},
